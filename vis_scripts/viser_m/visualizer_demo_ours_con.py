...
def main(
       ...
       if hmr_type == 'tram':
          ...
          pred_j3d = pred.joints[:, :24].numpy()
           ...
           pred_j3d =pred_j3dg = smpl_results['pred_j3dg']
            ...
            rl_path = '/data3/zihanwa3/_Robotics/humanoid/hybrid-imitation-parkour/post_results_0921'
   ...
   if True:
    ...
    sqs_mesh_path = nksr_mesh_path = os.path.join(base_papppath, 'scene_mesh_sqs/scene_mesh_sqs.obj')
