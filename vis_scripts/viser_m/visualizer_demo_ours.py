...
def main(
   ...
   nksr_mesh_path = os.path.join('/data3/zihanwa3/_Robotics/_vision/mega-sam/post_results', tgt_name, 'gv/scene_mesh_sqs/scene_mesh_sqs.obj')
   ...
   if True:
    sqs_mesh_path = nksr_mesh_path = os.path.join('/data3/zihanwa3/_Robotics/_vision/mega-sam/post_results', tgt_name, 'gv/scene_mesh_sqs/scene_mesh_sqs.obj')
   ...
   if True:
    ...
    if True:  # Set to True to enable rendering
      ...
      render_output_dir = f"/data3/zihanwa3/_Robotics/_geo/differentiable-blocksworld/_rendered_views/planar"
      os.makedirs(render_output_dir, exist_ok=True)

      render_output_dir = f"/data3/zihanwa3/_Robotics/_geo/differentiable-blocksworld/_rendered_views/planar/{tgt_name}"
      os.makedirs(render_output_dir, exist_ok=True)
      rendered_frames = []
